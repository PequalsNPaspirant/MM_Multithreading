...
#include "ReadWriteLock_LockFree_v1.h"
#include "ReadWriteLock_LockFree_v2.h"
#include "ReadWriteLock_LockFree_v3.h"
	...
	namespace readWriteLockTesting {
		...
		void testAllReadWriteLocks()
		{
			using LockTypes = std::tuple<
				...
				///readWriteLock_NoPref_LockFree_v2::ReadWriteLock,  /*FIX ME*/
				///readWriteLock_NoPref_LockFree_v3::ReadWriteLock,  /*FIX ME*/
